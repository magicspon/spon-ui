...
const controls = `
<button type="button" class="plyr__control plyr__control--overlaid bg-black h-100 w-130 rounded-play items-center justify-center" data-plyr="play" aria-label="Play, The New Vimeo Player (You Know, For Videos)">
	<svg role="presentation" focusable="false" style="width: 39px; height: 40px;">
...
export default class VideoPlayer {
	...
	mount = () => {
		this.player = new Plyr(this.$el, { controls })
	}
